...
export default class TrackProgressPage {
  ...
  private errors: ValidationErrors<TrackProgressPageInput>
  ...
  items() {
    const startDateInput = new GovukFrontendDateInput(this.query, 'startDate', Boolean(this.errors['startDate-day']))
    const endDateInput = new GovukFrontendDateInput(this.query, 'endDate', Boolean(this.errors['endDate-day']))
