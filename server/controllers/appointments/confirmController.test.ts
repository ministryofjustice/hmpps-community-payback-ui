...
describe('ConfirmController', () => {
  ...
  describe('create', () => {
    it('should render the check appointment details page for a new appointment', async () => {
      ...
      const headingSpy = jest.spyOn(AppointmentUtils, 'appointmentHeading').mockReturnValue(heading)
      ...
      expect(headingSpy).toHaveBeenCalledWith(caseDetailsSummary.offender, form.projectTypeGroup)
  ...
  describe('submitCreate', () => {
    it('should create appointment data and redirect to checkAppointmentDetails page', async () => {
      ...
      expect(exitFormSpy).toHaveBeenCalledWith({ projectCode, date: form.date }, 'GROUP', form)
    ...
    describe('given validation errors', () => {
      it('renders the page with submittedItems built from personItems and formItems', async () => {
        ...
        jest.spyOn(AppointmentUtils, 'appointmentHeading').mockReturnValue(offenderHeading)
