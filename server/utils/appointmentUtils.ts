...
export default class AppointmentUtils {
  ...
  static appointmentTypeDescriptions: Record<ProjectTypeDto['group'], string> = {
    GROUP: 'Group session',
  ...
  static appointmentHeading(offender: OffenderDto, appointmentGroupType: ProjectTypeDto['group']): PageHeader {
    return {
